        ...
        <form onSubmit={handleFormSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className='flex gap-4'>
                    ...
                    <button type="button" disabled={uploading} onClick={handleSubmit} className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'>{uploading? 'Uploading...' : 'Upload'}</button>
